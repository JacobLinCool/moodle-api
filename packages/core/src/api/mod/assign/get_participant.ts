export interface Params {
	...
	userid: number | null;
	/** user id */
	embeduser?: boolean | null;
}

export interface ReturnsUserCustomfieldsItem {
 ...
 */
export type ReturnsUserCustomfields = ReturnsUserCustomfieldsItem[];

export interface ReturnsUserPreferencesItem {
 ...
 * Users preferences
 */
export type ReturnsUserPreferences = ReturnsUserPreferencesItem[];
...
export interface ReturnsUser {
	...
	/** User custom fields (also known as user profile fields) */
	customfields: ReturnsUserCustomfields;
	/** Users preferences */
	preferences: ReturnsUserPreferences;
}
