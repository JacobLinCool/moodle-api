...
export interface ReturnsAssessmentsItemFeedbackcontentfilesItem {
	/** File name. */
	filename: string;
	/** File path. */
	filepath: string;
 ...
 */
export type ReturnsAssessmentsItemFeedbackcontentfiles =
	ReturnsAssessmentsItemFeedbackcontentfilesItem[];

export interface ReturnsAssessmentsItemFeedbackattachmentfilesItem {
	/** File name. */
	filename: string;
	/** File path. */
	filepath: string;
 ...
 */
export type ReturnsAssessmentsItemFeedbackattachmentfiles =
	ReturnsAssessmentsItemFeedbackattachmentfilesItem[];

export interface ReturnsAssessmentsItem {
	...
	/** feedbackattachmentfiles */
	feedbackattachmentfiles: ReturnsAssessmentsItemFeedbackattachmentfiles;
}

export type ReturnsAssessments = ReturnsAssessmentsItem[];
...
export interface Returns {
	assessments: ReturnsAssessments;
	/** list of warnings */
