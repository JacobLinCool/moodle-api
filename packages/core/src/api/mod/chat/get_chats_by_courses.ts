 ...
 * File.
 */
export interface ReturnsChatsItemIntrofilesItem {
	/** File name. */
 ...
 */
export type ReturnsChatsItemIntrofiles = ReturnsChatsItemIntrofilesItem[];

/**
 * Chats
 */
export interface ReturnsChatsItem {
	...
	/** Files in the introduction */
	introfiles: ReturnsChatsItemIntrofiles;
	/** Course section id */
	section: number | null;
	/** Visible */
...
export type ReturnsChats = ReturnsChatsItem[];
