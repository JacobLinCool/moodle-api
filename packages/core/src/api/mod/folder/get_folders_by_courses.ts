 ...
 * File.
 */
export interface ReturnsFoldersItemIntrofilesItem {
	/** File name. */
 ...
 */
export type ReturnsFoldersItemIntrofiles = ReturnsFoldersItemIntrofilesItem[];

export interface ReturnsFoldersItem {
	...
	/** Files in the introduction */
	introfiles: ReturnsFoldersItemIntrofiles;
	/** Course section id */
	section: number | null;
	/** Visible */
...
export type ReturnsFolders = ReturnsFoldersItem[];
