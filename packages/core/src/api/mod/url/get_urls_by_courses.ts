 ...
 * File.
 */
export interface ReturnsUrlsItemIntrofilesItem {
	/** File name. */
 ...
 */
export type ReturnsUrlsItemIntrofiles = ReturnsUrlsItemIntrofilesItem[];

export interface ReturnsUrlsItem {
	...
	/** Files in the introduction */
	introfiles: ReturnsUrlsItemIntrofiles;
	/** Course section id */
	section: number | null;
	/** Visible */
...
export type ReturnsUrls = ReturnsUrlsItem[];
