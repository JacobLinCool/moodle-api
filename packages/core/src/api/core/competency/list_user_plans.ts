...
export interface ReturnsItemCommentarea {
	/** component */
	component: string;
	/** commentarea */
	commentarea: string;
...
export interface ReturnsItemReviewer {
	/** id */
	id: number;
	/** email */
	email: string;
...
export interface ReturnsItemTemplate {
	/** shortname */
	shortname: string;
	/** description */
	description: string;
...
export interface ReturnsItem {
	...
	/** duedateformatted */
	duedateformatted: string;
	commentarea: ReturnsItemCommentarea;
	reviewer: ReturnsItemReviewer;
	template: ReturnsItemTemplate;
	/** url */
	url: string;
}
